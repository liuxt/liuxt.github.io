...
I am actively recruiting **self-motivated PhD students, graduate researchers, and undergraduate interns (both in-person and remote)** to join our **LEAD** research group (**L**earning, **E**valuation, and **A**dvanced **D**ecision-making), and work with me on theory and/or application frontiers of **RL, online learning, cost-effective LLM, and heterogenous edge/cloud computing**. Students will have opportunities to collaborate with leading researchers from **UW, CMU, UMass Amherst, Microsoft Research, and Adobe**, etc. If you're interested, please contact me with your CV.
