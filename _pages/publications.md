...
ACM International Conference on Measurement and Modeling of Computer Systems (**SIGMETRICS**), 2026 (Acceptance rate 20.7%).<br>
...
The Thirty-ninth Conference on Neural Information Processing Systems (**NeurIPS**), 2025. (Acceptance rate 24.5%).<br>
...
ACM SIGKDD International Conference on Knowledge Discovery and Data Mining (**KDD**), 2025. (Acceptance rate 18.4%).<br>
...
Forty-second International Conference on Machine Learning (**ICML**), 2025. (Acceptance rate 26.3%).<br>
...
IEEE International Conference on Computer Communications (**INFOCOM**), 2025. (Acceptance rate 18.7%).<br>
...
Forty-first International Conference on Machine Learning (**ICML**), 2024 (Acceptance rate 27.5%).<br>
...
The 38th AAAI Conference on Artificial Intelligence (**AAAI**), 2024. (Acceptance rate 23.75%).<br>
...
IEEE International Conference on Computer Communications (**INFOCOM**), 2024. (Acceptance rate 19.6%).<br>
...
The Thirty-seventh Conference on Neural Information Processing Systems (**NeurIPS**), 2023. (Acceptance rate 26.1%).<br>
...
- **<font color="blue">[ICML '23]</font>** [**Contextual Combinatorial Bandits with Probabilistically Triggered Arms**](https://arxiv.org/abs/2303.17110) <br>
**Xutong Liu**, Jinhang Zuo, Siwei Wang, John C.S. Lui, Mohammad Hajiesmaili, Adam Wierman, Wei Chen.<br>
The 40th International Conference on Machine Learning (**ICML**), 2023. (Acceptance rate 27.9%).<br>
...
IEEE International Conference on Computer Communications (**INFOCOM**), 2023. (Acceptance rate 19.2%).<br>
...
Thirty-Seventh AAAI Conference on Artificial Intelligence (**AAAI**), 2023. (Acceptance rate 19.6%).<br>
...
Thirty-sixth Conference on Neural Information Processing Systems (**NeurIPS**), 2022. (Acceptance rate 25.6%).<br>
...
The 38th Conference on Uncertainty in Artificial Intelligence (**UAI**), 2022. (Acceptance rate 32%).<br>
...
The 25th International Conference on Artificial Intelligence and Statistics (**AISTATS 2022**), (Acceptance rate 29%)<br>
...
2021 and before
------
- **[<font color="red">ICML '21</font>, 🎤️<font color="red">Long Oral</font>]** [**Multi-layered Network Exploration via Random Walks: From Offline Optimization to Online Learning**](http://proceedings.mlr.press/v139/liu21ae.html)<br>
